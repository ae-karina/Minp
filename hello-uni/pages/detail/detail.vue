<template>
	<view class="">
		...
		<view>
			<text selectable space="nbsp" style="font-size: 100px;">唱歌  跳舞打篮球</text>
		</view>
		...
		<view class="box2" hover-class="box2-active">
			<view class="box" :hover-start-time="2000" :hover-stay-time="2000" hover-class="box-active"
				hover-stop-propagation>我是一个大盒子</view>
		</view>
		<button>按钮</button>
