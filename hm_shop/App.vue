...
<style>
	...
	@font-face {
		...
		src: url('~@/static/font/iconfont.eot?t=1564622062967');
		/* IE9 */
		src: url('~@/static/font/iconfont.eot?t=1564622062967#iefix') format('embedded-opentype'),
			/* IE6-IE8 */
			...
			url('~@/static/font/iconfont.woff?t=1564622062967') format('woff'),
			url('~@/static/font/iconfont.ttf?t=1564622062967') format('truetype'),
			/* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
			url('~@/static/font/iconfont.svg?t=1564622062967#iconfont') format('svg');
		/* iOS 4.1- */
	}
